    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(135deg, #6D5DE6 0%, #4A1D8F 100%)',
          color: '#fff', fontFamily: 'sans-serif', overflow: 'hidden',
        }}
      >
        <svg
          width="620" height="672" viewBox="0 0 2581.7 2800"
          style={{ position: 'absolute', right: -80, top: 40, opacity: 0.12 }}
          fill="#ffffff"
        >
        ...
        <div style={{ display: 'flex', fontSize: 74, fontWeight: 900, lineHeight: 1.05, marginTop: 18, maxWidth: 820, letterSpacing: -2 }}>
          Minifiguras LEGO que no consigues en tienda
        </div>
        <div style={{ display: 'flex', fontSize: 30, marginTop: 26, opacity: 0.92 }}>
