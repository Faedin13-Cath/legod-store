    ...
    (
      <div
        style={{
          ...
          justifyContent: 'center', padding: '72px 80px', position: 'relative',
          background: '#FFFFFF',
          color: '#1A1E5A', fontFamily: 'sans-serif', overflow: 'hidden',
        }}
      >
        <svg
          width="620" height="672" viewBox="0 0 2581.7 2800"
        ...
        <div style={{ display: 'flex', fontSize: 28, fontWeight: 800, letterSpacing: 5, color: '#5526AD' }}>
          {"JANGO'S STORE"}
        </div>
        <div style={{ display: 'flex', fontSize: 74, fontWeight: 900, lineHeight: 1.05, marginTop: 18, maxWidth: 820, letterSpacing: -2, color: '#1A1E5A' }}>
          Minifiguras LEGO que no consigues en tienda
        </div>
        <div style={{ display: 'flex', fontSize: 30, marginTop: 26, color: '#5B5F8A' }}>
