...
export default function TerminosPage() {
  return (
    <LegalPage title="Términos y Condiciones" updated="agosto 2026">
      ...
      <H2>3. Apartados</H2>
      <p>Puedes apartar una pieza con un anticipo del <strong>60%</strong> del costo. Los clientes nuevos cuentan con <strong>2 días hábiles</strong> para realizar el depósito del apartado; de lo contrario la pieza se libera.</p>
