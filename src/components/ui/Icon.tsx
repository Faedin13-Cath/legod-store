...
const paths: Record<string, React.ReactNode> = {
  ...
  tiktok:      <><path d="M14 3v11.5a3.5 3.5 0 1 1-3.5-3.5"/><path d="M14 3c.6 2.6 2.6 4.4 5 4.6"/></>,
  ...
  /* ── Categorías ── */
  'cat-starwars': <><circle cx="12" cy="12" r="9"/><circle cx="8.5" cy="8.5" r="2.2"/><path d="M3.2 12.5h17.6"/></>,
  // Marvel — escudo del Capitán América (círculos + estrella)
  'cat-marvel':   <><circle cx="12" cy="12" r="9.5"/><circle cx="12" cy="12" r="5.7"/><polygon points="12 8.7 12.85 10.75 15.05 10.85 13.3 12.2 13.95 14.35 12 13.15 10.05 14.35 10.7 12.2 8.95 10.85 11.15 10.75 12 8.7"/></>,
  // DC — escudo de Superman (diamante + S)
  'cat-dc':       <><path d="M5 6.4 12 4l7 2.4-1.9 6.7L12 20.5 6.9 13.1z"/><path d="M14.4 9.5c-1.2-.9-3.7-.75-3.95.75-.2 1.3 1.6 1.55 2.55 1.75s2.45.6 2.2 1.95c-.25 1.55-2.75 1.7-3.95.8"/></>,
  'cat-harry':    <><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z"/></>,
  'cat-stranger': <><path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-4 10.5c.7.8 1 1.5 1 2.5h6c0-1 .3-1.7 1-2.5A6 6 0 0 0 12 3z"/></>,
  'cat-castle':   <><path d="M3 21V8l2.5 1V6h2v3l4.5-2 4.5 2V6h2v3L21 8v13z"/><path d="M2.5 21h19"/><path d="M9.5 21v-4h5v4"/></>,
  'cat-sports':   <><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 4h10v5a5 5 0 0 1-10 0z"/><path d="M7 6H4v1.5a3 3 0 0 0 3 3"/><path d="M17 6h3v1.5a3 3 0 0 1-3 3"/></>,
